...
public class AnswerController {
    ...
    @ApiOperation(value = "Get Answers for Question Id")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Get Answer by answer Id")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Data fetched successful"),
    ...
    @ApiOperation(value = "This is used to update an answer")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "This is used to delete answer by id")
    @ApiResponses(value = {
